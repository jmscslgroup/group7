...
runuser -l $LIBPANDA_USER -c /etc/libpanda.d/apps/group7/installRosPackages.sh
...
rosrun robot_upstart install group7/launch/${LAUNCH_FILE} --user root

echo "Enabling can_to_ros startup script"
sudo systemctl daemon-reload
sudo systemctl enable group7
popd
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
